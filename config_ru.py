...
ТЕКСТЫ: Dict[str, Dict[str, str]] = {
    "ru": {
        ...
        "приветствие": "👋 Добро пожаловать! Я — ваш умный ИИ-помощник.\n\n🎯 Что умею:\n💬 Вести умные диалоги и отвечать на вопросы\n🎨 Создавать уникальные изображения\n🔍 Анализировать ваши фотографии\n🔊 Распознавать речь и отвечать голосом\n🛠 Использовать полезные инструменты\n⏰ Ставить напоминания\n\n👆 Используйте кнопки для навигации!",
